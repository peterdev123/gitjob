...
=======
            'job_title': forms.TextInput(attrs={'class': 'w-full border border-black  p-2', 'placeholder': 'Enter Job Title', 'required': True}),
            'job_field': forms.Select(attrs={'class': 'w-full border border-black p-2', 'required': True}),
            'job_schedule': forms.Select(attrs={'class': 'w-full border border-black p-2', 'required': True}),
            'address': forms.TextInput(attrs={'class': 'w-full border border-black  p-2', 'placeholder': 'Enter Company Address', 'required': True}),
            'hiring_deadline': forms.DateInput(attrs={'class': 'w-full border border-black  p-2', 'type': 'date', 'required': True}),
            'min_salary': forms.NumberInput(attrs={'class': 'w-full border border-black  p-2', 'placeholder': 'Enter Minimum Salary', 'required': True}),
            'max_salary': forms.NumberInput(attrs={'class': 'w-full border border-black  p-2', 'placeholder': 'Enter Maximum Salary', 'required': True}),
            'job_description': forms.Textarea(attrs={'class': 'w-full border border-black  p-2', 'rows': 4, 'placeholder': 'Enter Job Description', 'required': True}),
            'core_competencies': forms.Textarea(attrs={'class': 'w-full border border-black  p-2', 'rows': 3, 'placeholder': 'Enter Core Competencies', 'required': True}),
            'tags': forms.TextInput(attrs={'class': 'w-full border border-black  p-2', 'placeholder': 'Enter Tags (comma-separated)', 'required': True}),
